...
//
function mailSend($mailtxt){
require ("smtp.php");
$smtpserver = "smtp.qq.com"; //SMTP服务器

$smtpserverport =25;                      //SMTP服务器端口

//$smtpusermail = "owenshen@outlook.com";      //SMTP服务器的用户邮箱

$smtpemailto = "shenting@yonglun.com.cn,8844413053@qq.com";       //发送给谁

$smtpuser = "414655200@qq.com";         //SMTP服务器的用户帐号

$smtppass = "esskexglqjwlbjed";                 //SMTP服务器的用户密码

$mailsubject = "EA运行监控";        //邮件主题

$mailbody = characet($mailtxt);              //邮件内容

//$mailbody = "<h1>你的用户名是张三，密码是123147mcl </h1>";     
